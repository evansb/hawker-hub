    ...
    <div>
      ...
      <div className="container">
        ...
        <p>This Privacy Policy describes how users personal information is handled in
          ...
          generally to web pages where this policy appears in the footer.
          ...
          this Privacy Policy. This Privacy Policy is effective upon acceptance for new users and is otherwise effective on August 12, 2015.
        </p>
        <h2>Definitions</h2>
        <p>
        <ol>
          <li>
            References to "Our", "We", "Us" and "HawkerHub" shall be references to "HawkerHub".
          </li>
          <li>
        ...
        <ol>
          <li>
            Private information such as name and birthdate
          </li>
          <li>
            Contact information such as email address, mobile number and physical address
          </li>
          <li>
            Additional information which we may ask for if we believe the site policies are violated
          </li>
